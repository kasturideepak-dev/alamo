...
SERVICES = {
    "wl": ("Weight Loss Services", "weight-loss.html#plan",
        ...
        ("i-truck", "Free Medication Delivery", "weight-loss.html#delivery", "s01-telemedicine",
         "Your prescription brought to your door."),
    ...
    "ae": ("Aesthetic Treatments", "aesthetics.html#visit",
           ("assets/img/svc-aesthetics.jpg", "You, only more rested",
            "Natural results, planned in a medical setting.", "Book a consultation"), [
        ("i-sparkle", "Botox", "aesthetics.html#expect", "svc-aesthetics",
         "Softens forehead, frown and crow&rsquo;s-feet lines."),
        ("i-drop", "Dermal Filler", "aesthetics.html#expect", "s05-procedures",
         "Restores volume to lips, cheeks and folds."),
        ("i-plus", "Sculptra", "aesthetics.html#expect", "s08-womens",
         "Rebuilds collagen gradually for lasting results."),
        ("i-chat", "What to Expect", "aesthetics.html#expect", "s01-telemedicine",
         "Visit lengths and when you&rsquo;ll see results."),
        ("i-heart", "Your Visit, Step by Step", "aesthetics.html#visit", "s06-geriatric",
         "Consultation, plan, treatment and aftercare."),
        ("i-cal", "Book a Consultation", "aesthetics.html#visit", "s09-referrals",
         "Talk through your goals with our providers."),
    ]),
}
